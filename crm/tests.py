...
class CrmTestCase(TestCase):
    def setUp(self):
        ...
        self.driver = Driver.objects.create(
            ...
            passport_issue_date=date(2020, 5, 12),
    ...
    def test_new_transportation_and_organization_cards_render(self):
        ...
        self.assertContains(detail, "trip-work-header")
        self.assertContains(detail, "trip-work-sidebar")
        self.assertContains(detail, "transportation-detail-tabs")
        self.assertContains(detail, "Изменить цепочку")
        self.assertNotContains(detail, "Назначить исполнение")
    ...
    def test_transportation_register_has_counterparty_style_scopes(self):
        ...
        self.assertContains(register, 'id="transportations-title"')
        self.assertContains(register, 'orders-page-header')
        self.assertContains(register, "Создать заказ")
        self.assertNotContains(register, "Создать рейс")
        self.assertContains(register, '<span class="orders-count">1</span>', html=True)
        self.assertContains(register, '<option value="active">Активные</option>', html=True)
